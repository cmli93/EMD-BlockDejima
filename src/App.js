...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <nav className="navbar pure-menu pure-menu-horizontal">
          ...
          <Link to="/" className="pure-menu-heading pure-menu-link">Welcome to EMRDejima system!</Link>
        </nav>
    ...
    return (
      <div className="App">
        <nav className="navbar pure-menu pure-menu-horizontal">
            <a href="#" className="pure-menu-heading pure-menu-link">Welcome to EMRDejima system!</a>
        </nav>
